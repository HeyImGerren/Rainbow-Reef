...
public class Explosion implements Observer {
  ...
  public Explosion( String explosionImage, int xCoordinate, int yCoordinate, int tileW, int tileH ) throws IOException {
    explosionSprite = new Sprite( explosionImage, tileW, tileH, true );
    this.x = xCoordinate;
    this.y = yCoordinate;
  ...
  public void update( Observable observable, Object o ) {
    if ( !this.explosionComplete ) {
      ...
      if ( this.frameDisplayed == 0 && frameCount >= 6 ) {
